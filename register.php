...
$dbusername = "root";    // username MySQL biasanya root
$dbpassword = "";        // password biasanya kosong di localhost
$dbname = "simbs";   // ganti dengan nama database kamu


$conn = new mysqli($servername, $dbusername, $dbpassword, $dbname);
// Cek koneksi
if ($conn->connect_error) {
    die("<h2 style='color:red'>Koneksi database gagal: ".$conn->connect_error."</h2>");
}
...
if($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    if(strlen($password) < 8) {
        $error = 'Password harus mengandung minimal 8 karakter';
    } else {
        ...
        if($res->fetch_assoc()) {
            ...
            if($stmt2->execute()) {
                ...
                exit;
            } else $error='Gagal mendaftarkan akun.';
        }
    }
}
?>
